...
export class Player {
  ...
  /** The melee weapon to hand back after a respawn. */
  get _meleeId() { return this.loadout ? this.loadout.melee : 'knife'; }
